...
sudo apt-get install -y php5 apache2 libapache2-mod-php5 php5-curl php5-gd php5-mcrypt mysql-server-5.5 php5-mysql git-core nodejs
...
echo "--- Ok its time to install sass and compass for your styling ---"
sudo apt-get install -y ruby make build-essential
sudo gem install sass haml compass
